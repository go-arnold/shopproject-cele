const products = JSON.parse(
  document.getElementById('productes-data').textContent
);
                ...
                const productCard = `
                    <div class="product-card fade-in" data-category="${product.category}">
                        <div class="product-image">
                            <span class="product-emoji"><img src="${product.image}"  alt="may be an image of ${product.name}" style="max-width: 100%;"></span>
